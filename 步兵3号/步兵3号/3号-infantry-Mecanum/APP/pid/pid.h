...
//功率环宏定义
#define POWER_Integral_max         400// 3000
#define POWER_IntegralSeparation    10//20
#define PID_OUT_MAX_POWER          1000		//即最大速度
#define P_OUT_MAX_POWER          	1000

#define PID_OUT_MAX_BUFF          1000		//即最大速度
...
#define pid_init() \
				do{ \
					/*底盘位置环*/                        \
					chassis_center.pid.position_loop.pid_Parameter.Akp = 0.165; \
					chassis_center.pid.position_loop.pid_Parameter.Aki = 0; \
					chassis_center.pid.position_loop.pid_Parameter.Akd = 0.02; \
					...
					chassis_center.pid.speed_loop.pid_Parameter.Vkd = 0.1; \
					                   \
					/*轮子速度环*/       \
					chassis_motor1.pid.speed_loop.pid_Parameter.Vkp = 4.9;   \
					chassis_motor2.pid.speed_loop.pid_Parameter.Vkp = 4.9;   \
					chassis_motor3.pid.speed_loop.pid_Parameter.Vkp = 4.9;   \
					chassis_motor4.pid.speed_loop.pid_Parameter.Vkp = 6.9;   \
					     \
					/*功率环*/   \
					b_pid.kp=4.9; \
					b_pid.ki=1.7; \
