...
//	if(buffer<BUFFER_MAX*0.25) CHASSIS_vPID_max=1900;
//	if(CHASSIS_vPID_max<=2000 && buffer>=BUFFER_MAX*0.50f ) CHASSIS_vPID_max=2500;
//	if(CHASSIS_vPID_max<=2600 && buffer>=BUFFER_MAX*0.75f ) CHASSIS_vPID_max=4200;
