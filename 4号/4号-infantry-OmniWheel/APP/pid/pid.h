...
#define aPID_OUT_MAX_FOLLOW         1.5		//即最大速度
#define aP_OUT_MAX_FOLLOW          	1.5
...
#define pid_init() \
				do{ \
					...
					chassis_center.pid.speed_loop.pid_Parameter.Vkd = 0.1; \
					                   \
					/*轮子速度环*/       \
					chassis_motor1.pid.speed_loop.pid_Parameter.Vkp = 5.1;   \
					chassis_motor2.pid.speed_loop.pid_Parameter.Vkp = 5.5;   \
