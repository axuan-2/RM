...
//void get_UI_id(uint16_t *sender_ID,uint16_t *receiver_ID)
//{
//    *sender_ID = student_interactive_data_t.sender_ID;
//    *receiver_ID = student_interactive_data_t.receiver_ID;
//}
