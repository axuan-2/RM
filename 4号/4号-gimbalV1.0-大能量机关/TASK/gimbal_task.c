...
float YawEncondePid[6] 	= {0.14f,			0.0f,			0.0f,		1.5f,			0.0f,		0.0f};  //编码器角度环
float YawEncondePidSpeed[6] 	= {1500.0f,			500.0f,			0.0f,		20000.0f,			5000.0f,		0.0f};  //编码器角度环
float YawSpeedPid[6] 			= {18000.0f,			4600.0f,			0.0f,		20000.0f,			1200.0f,		0.01f};     //速度环
...
float PitchSpeedPid[6] 		= {2600.0f,			300.0f,			0.0f,		3000.0f,	1000.0f,	0.00f};
...
static void GIMBAL_CALBACK_GET(void)
{
  gimbal_y.CAN_actual_angle=yaw_can_rx.angle; 
